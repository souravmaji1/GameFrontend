...
import ProfitChecked from "../assets/images/ProfitChecked.svg";

function ChartPageUP() {
...
<div id="crypto-chart" ref={chartContainerRef} className="mt-8" style={{ width: '100%', height: '350px' }}>
  ...
  <button className="text-center bg-[#0F2249] mx-14 pt-4 pb-2 mt-3 rounded-[22px]"  style={{width:'-webkit-fill-available',border:'none'}} onClick={() => handleGuess(true)}  >

 
  <span className='text-white text-[12px] font-bold font-inter'>Your Guess</span>
            <h2 className='text-white text-[24px] font-bold font-inter'>UP <span>&uarr;</span></h2>
